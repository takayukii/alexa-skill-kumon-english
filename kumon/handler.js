...
const handlers = {
  ...
  'AskPractice': function () {
    ...
    const message = `Welcome to kumon English practice service. We're offering listen repeat practice and question answer practice. Which practice do you want to try?`;
