...
const handlers = {
  ...
  'AskPractice': function () {
    ...
    const message = `Welcome to Kumon English practice. You can try practice of listen repeat <break time='200ms'/> and question answer. Which practice do you want to try?`;
